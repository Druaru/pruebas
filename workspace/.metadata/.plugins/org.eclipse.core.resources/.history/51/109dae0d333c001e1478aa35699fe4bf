...
public class AppConfig {
	...
	public List<ItemFactura> registrarItemsOficina() {
		...
		Producto producto1 = new Producto("Monitor LG LCD 24''", 50);
		Producto producto2 = new Producto("Notebook ASUS", 500);
		Producto producto3 = new Producto("Impresora HP multifuncion", 230);
		Producto producto4 = new Producto("Escritorio Elevable Oficina", 130);
