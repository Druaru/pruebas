...
import com.cursos.api.springsecuritycourse.persistence.repository.security.OperacionRepository;
import com.cursos.api.springsecuritycourse.persistence.security.GrantedPermission;
...
public class CustomAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
	...
	private List<Operation> obtainOperations(Authentication authentication) {
		...
		User user = userService.findOneByUsername(username)
				.orElseThrow(() -> new com.cursos.api.springsecuritycourse.exception.ObjectNotFoundException(
